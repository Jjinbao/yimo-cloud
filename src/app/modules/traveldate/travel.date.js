...
angular.module('swalk.traveldate', [])
    .controller('travelDate', ['$rootScope', '$scope','$ionicModal', '$ionicHistory', '$ionicViewSwitcher', 'ionicDatePicker', 'IonicDatepickerService',
        function ($rootScope, $scope,$ionicModal, $ionicHistory, $ionicViewSwitcher, ionicDatePicker, IonicDatepickerService) {
            var config = {
                setLabel: 'Set',
                todayLabel: 'Today',
                closeLabel: 'Close',
